...
License: DonHash Attribution License v1.0 (DH-AL)
  Copyright (c) 2026 CySec Don (cysecdon@gmail.com)
  https://github.com/cysec-don/DonHash

  All copies, forks, updates, modifications, or commercial applications
  MUST attribute CySec Don (cysecdon@gmail.com). See LICENSE for full terms.
""",
    )
